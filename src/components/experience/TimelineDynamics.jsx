        ...
        >
          <div
            className={`relative w-full max-w-sm sm:max-w-md md:max-w-lg rounded-lg shadow-xl border overflow-hidden transform transition-all duration-300 ${
              isDarkMode
                ? "bg-solarized-base03 border-solarized-ghBorder"
                : "bg-white border-solarized-borderLight"
            }`}
          ...
          >
            ...
            >
              ...
              <h4
                className={`text-sm mt-1 text-center ${
                  isDarkMode ? "text-solarized-ghMuted" : "text-solarized-ghDim"
                }`}
              >
            ...
            <div
              className={`p-4 ${
                ...
                isDarkMode ? "border-solarized-ghBorder" : "border-solarized-borderLight"
              }`}
            >
              <button
                onClick={() => setSelectedMilestone(null)}
                className={`px-4 py-2 text-base font-medium rounded-md w-full shadow-sm focus:outline-none focus:ring-2 transition-all duration-300 ${
                  isDarkMode
                    ? "bg-solarized-blue text-solarized-base3 hover:bg-solarized-cyan focus:ring-solarized-cyan"
                    : "bg-solarized-blue text-solarized-base3 hover:bg-solarized-cyan focus:ring-solarized-cyan"
                }`}
              >
                Close
  ...
  return (
    <div className="timeline-item-wrapper">
      <VerticalTimelineElement
        ...
        date={item.date}
        dateClassName={`${isDarkMode ? "text-solarized-base1" : "text-solarized-base03"} 
            ...
            className={`w-full h-full rounded-full overflow-hidden transition-all duration-300 ease-in-out ${
              isHovered
                ? `ring-4 ring-opacity-50 ring-offset-2 ${
                    isDarkMode
                      ? "ring-solarized-blue ring-offset-solarized-base03"
                      : "ring-solarized-cyan ring-offset-white"
                  }`
                : ""
            }`}
          >
        ...
        >
          ...
          <div
            className={`text-xs sm:text-sm font-semibold mt-4 ${
              isDarkMode ? "text-solarized-blue" : "text-solarized-blue"
            }`}
          >
