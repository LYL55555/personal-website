    ...
    },
    {
      ...
      content: (
        <div className="flex flex-col items-center justify-start w-full max-w-2xl mx-auto px-4 sm:px-6">
          <div className="relative group w-full flex justify-center mb-4 sm:mb-5">
            <Image
              src="/images/school-placeholder.svg"
              alt="Your school or university (placeholder)"
              width={300}
              height={300}
                                  ...
                                  {typeof course === "string" ? (
                                    ...
                                    (() => {
                                      const achievementFull =
                                        typeof course.achievement === "string"
                                          ? course.achievement
                                          : [
                                    ...
                                    <div className="w-full min-w-0 leading-tight">
                                      ...
                                      {course.instructor && (
                                        <>
                                          {" "}
                                          <span
                                            className={`inline-flex max-w-full align-middle items-center gap-1 rounded border px-1.5 py-0 leading-none ${
                                              isDarkMode
                                                ? "border-[#30363d]/90 bg-[#0d1117]/70"
                                                : "border-[#d0d7de] bg-white/50"
                                            }`}
                                          >
                                            ...
                                            <a
                                              ...
                                              target="_blank"
                                              rel="noopener noreferrer"
                                              className={`min-w-0 truncate text-xs font-medium leading-tight underline decoration-1 underline-offset-1 hover:opacity-85 ${
                                                isDarkMode
                                                  ? "text-[#58a6ff]"
                                                  : "text-[#0969da]"
                                              }`}
    ...
    },
    {
      ...
      content: (
        <div className="flex justify-center items-center">
          ...
          >
            <li>Example Cloud Certification — replace with yours</li>
          </ul>
        </div>
      ),
    },
    {
      ...
      content: (
        <div className="flex flex-col justify-center items-center">
          <div
            className={`flex h-[120px] w-[120px] items-center justify-center rounded-full border-2 border-dashed text-xs font-medium px-2 text-center
              ${
                isDarkMode
          ...
          <ul
            className={`list-disc pl-4 text-center mt-4
                         ${isDarkMode ? "text-[#ADB7BE]" : "text-[#586e75]"}`}
          >
            <li>Example: Outstanding Carrot Scholar (template)</li>
          </ul>
        </div>
      ),
    },
